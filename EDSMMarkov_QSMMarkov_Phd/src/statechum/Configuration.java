...
public class Configuration implements Cloneable {
	...
	public enum ScoreMode {
		CONVENTIONAL, COMPATIBILITY, KTAILS, KTAILS_ANY, GENERAL, ONLYOVERRIDE,COMPATIBILITYBlueFringe
	}
	...
	public enum QuestionGeneratorKind {
		CONVENTIONAL, CONVENTIONAL_IMPROVED, SYMMETRIC, ORIGINAL, DUPONT, ABDULLAH
	}
	...
	/**
	 * Whether we should try recompute score .
	 */
	protected boolean RecomputeScore = false;

	public void setRecomputeScore(boolean ask) {
		RecomputeScore = ask;
	}

	public boolean getRecomputeScore() {
