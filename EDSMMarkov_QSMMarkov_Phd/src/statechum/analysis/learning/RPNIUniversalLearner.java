...
//				while(getTentativeAutomaton().pairscores.computePairCompatibilityScore_general(pair, null, verticesToMerge) < 0)
//				{
//					if(possibleMerges.isEmpty())
//					{
//					    possibleMerges = topLevelListener.ChooseStatePairs(getTentativeAutomaton());
//					    pair = possibleMerges.pop();
//					}
//					else
//						pair = possibleMerges.pop();
//				}
...
////							questions.addAll(MarkovQuestionGeneration.computeOneStep(pair, getTentativeAutomaton(), getTentativeAutomaton(), false));
//						}
//						else
//							questions=topLevelListener.ComputeQuestions(pair, getTentativeAutomaton(), temp);// all answers are considered "hard", hence we have to ask questions based on hard facts in order to avoid prefixes which are not valid in hard facts
//
...
////					Visualiser.updateFrame(ptaHardFacts, ptaSoftFacts);
...
////			Visualiser.updateFrame(getTentativeAutomaton(), null);
//			possibleMerges = topLevelListener.ChooseStatePairs(getTentativeAutomaton());
//		}
//		
